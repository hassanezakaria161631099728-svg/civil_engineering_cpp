...
frame_generation_input readInput(const char* filename)
{
    ...
    while(file >> word)
    {
        ...
        else if(word == "hstory") file >> d.hstory;
        ...
        else if(word == "h") file >> d.h;
        else if(word == "n") file >> d.n;
        else if(word == "L") file >> d.L;
        else if(word == "Aver") file >> d.Aver;
        else if(word == "Iver") file >> d.Iver;
        else if(word == "Ahor") file >> d.Ahor;
        else if(word == "Ihor") file >> d.Ihor;
        else if(word == "Adiag") file >> d.Adiag;
        else if(word == "Idiag") file >> d.Idiag;
    }
