...
double computeDeflection(const dynamic_input& d, double I, double E);
double computef(const dynamic_input& d, double I, double E);
std::vector<std::vector<double>>
buildMassMatrix(const dynamic_input& d);
std::vector<std::vector<double>>
