...
std::vector<Element> wall_bracing_Elements(int n, double E, double Aver, double Iver,
...
std::vector<Node> roof_bracing_Nodes(double h, int n, double L)
{
    std::vector<Node> nodes;
...
std::vector<Element> roof_bracing_Elements(int n,double E,double Aver, double Iver,
double Ahor, double Ihor, double Adiag, double Idiag, double q)
{
    std::vector<Element> elements;
...
std::vector<DOF> roof_bracing_DOFs(int n)
{
    std::vector<DOF> dofs;
...
std::vector<Node> tall_building_Nodes(const BuildingData& d,
    int nspan,
    int Lspan,
    int nstories,
    int h)
...
std::vector<Element> tall_building_Elements(const BuildingData& d,
    int nspan,
    int nstories,
    double E,
